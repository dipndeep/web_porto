...
const projects = [
  {
    ...
    description:
      'Interactive dashboard for analyzing sales trends, customer segmentation, and revenue forecasting using Python and data visualization libraries.',
  ...
  },
  {
    ...
    description:
      'End-to-end machine learning pipeline for predicting customer churn, featuring data preprocessing, model training, and evaluation metrics.',
    image: '/project-ml-model.png',
    tags: ['Scikit-learn', 'TensorFlow', 'Python', 'Jupyter'],
    github: 'https://github.com',
  },
  {
