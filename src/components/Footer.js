...
const iconMap = { GitHub: GithubIcon, LinkedIn: LinkedInIcon, Instagram: InstagramIcon };
            ...
            {socials.map((s) => {
              ...
              return (
                <a key={s.name} href={s.url} target="_blank" rel="noopener noreferrer"
                  className={styles.socialLink} aria-label={s.name} id={`footer-${s.name.toLowerCase()}`}>
                  <Icon />
                </a>
              );
            })}
